...
type AggregateRequest struct {
	...
	ProducedAtUnixNano int64                  `protobuf:"varint,3,opt,name=ProducedAtUnixNano,proto3" json:"ProducedAtUnixNano,omitempty"`
...
func (x *AggregateRequest) GetProducedAtUnixNano() int64 {
	if x != nil {
		return x.ProducedAtUnixNano
	}
	return 0
}

func (x *AggregateRequest) GetEventID() string {
	if x != nil {
		return x.EventID
	}
	return ""
...
const file_types_ptypes_proto_rawDesc = "" +
	...
	"\x05ObuId\x18\x01 \x01(\x05R\x05ObuId\"\x88\x01\n" +
	"\x10AggregateRequest\x12\x14\n" +
	"\x05ObuID\x18\x01 \x01(\x05R\x05ObuID\x12\x14\n" +
	"\x05Value\x18\x02 \x01(\x01R\x05Value\x12.\n" +
	"\x12ProducedAtUnixNano\x18\x03 \x01(\x03R\x12ProducedAtUnixNano\x12\x18\n" +
	"\aEventID\x18\x04 \x01(\tR\aEventID23\n" +
	"\n" +
	"Aggregator\x12%\n" +
	"\tAggregate\x12\x11.AggregateRequest\x1a\x05.NoneB#Z!github.com/24aysh/toll-calc/typesb\x06proto3"
